...
npm i extract-text-webpack-plugin google-fonts-webpack-plugin html-webpack-plugin html-webpack-template style-loader css-loader babel-loader babel-core babel-preset-latest react react-router-dom babel-preset-react webpack file-loader react-router react-router-dom google-maps-react react-dropzone
